...
- Supported ML model development for IoT, emphasizing performance tuning and evaluation.  
- Conducted literature reviews, data prep, and visualizations for energy-efficient systems.  
...
- **President — Pakistan Student Association Saarland**  
  Driving academic/cultural initiatives for Pakistani students.  

- **ML Instructor — LIVEX-UMT** (Volunteer)  
  Taught ML fundamentals; mentored undergrad capstones.  

- **Management Head — TAAKRA’23**  
  Led logistics for Pakistan's top inter-uni competition.  

- **Volunteer — Al-Khidmat Foundation**  
  Community drives (plantation/ration, 2023).  

- **Director Linguistics & Writer’s Group — UCP Societies**  
  Mentored writing teams; hosted workshops/debates.  
...
<div align="center">
    ...
    [![Email](https://img.shields.io/badge/Email-hafizahajra6@gmail.com-D14836?style=flat&logo=gmail&logoColor=white)](mailto:hafizahajra6@gmail.com)
</div>
